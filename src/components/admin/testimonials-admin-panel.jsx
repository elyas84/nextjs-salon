...
function OrderStarsPicker({ value, onChange, disabled }) {
  ...
  return (
    <div
      className="inline-flex gap-0.5 rounded-xl border border-white/10 bg-[#0c0b09]/80 p-1.5"
      role="group"
      ...
      {[1, 2, 3, 4, 5].map((n) => (
        <Star
          ...
          className={`size-3.5 shrink-0 ${
            n <= v ? "fill-amber-400 text-amber-400" : "text-zinc-700"
          }`}
        />
      ))}
    </div>
...
export default function TestimonialsAdminPanel() {
  ...
  const inputClass =
    "w-full rounded-xl border border-white/10 bg-[#0c0b09] px-3 py-2 text-sm text-zinc-100 outline-none focus:ring-2 focus:ring-amber-500/30";
  const labelClass =
      ...
      <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 sm:p-6">
        ...
        <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-end">
          ...
          <button
            ...
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl border border-amber-500/40 bg-amber-500/15 px-4 py-2 text-xs font-black uppercase tracking-widest text-amber-100 transition hover:bg-amber-500/25 disabled:opacity-50"
          >
            {savingHeadline ? (
      ...
      >
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2 flex flex-col gap-4 sm:flex-row sm:items-end">
            <div
              className="flex size-16 shrink-0 items-center justify-center rounded-full border border-amber-500/35 bg-gradient-to-br from-amber-500/30 to-zinc-900 font-heading text-lg font-bold tracking-tight text-amber-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] ring-1 ring-white/10"
              aria-hidden
            >
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button
            type="submit"
            disabled={saving}
            className="inline-flex items-center gap-2 rounded-xl border border-amber-500/40 bg-amber-500/20 px-4 py-2.5 text-xs font-black uppercase tracking-widest text-amber-100 transition hover:bg-amber-500/30 disabled:opacity-50"
          >
            {saving ? (
              <Loader2 className="size-4 animate-spin" />
            ) : editingId ? (
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <div className="mt-3 flex items-center gap-2">
                        <div
                          className="flex size-8 shrink-0 items-center justify-center rounded-full border border-white/15 bg-gradient-to-br from-amber-500/25 to-zinc-900 text-[11px] font-bold text-amber-200"
                          aria-hidden
                        >
                    ...
                    >
                      ...
                      <td className="px-3 py-3 align-middle">
                        <div className="flex items-center gap-3">
                          <div
                            className="flex size-9 shrink-0 items-center justify-center rounded-full border border-white/15 bg-gradient-to-br from-amber-500/25 to-zinc-900 text-[11px] font-bold text-amber-200"
                            aria-hidden
                          >
                            {initialsFromName(t.name)}
                          </div>
