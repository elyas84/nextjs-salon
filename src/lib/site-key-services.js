...
export const SITE_KEY_SERVICES_DEFAULTS = {
  ...
  headline: "PRECISION TUNING",
  intro:
    "Our facility is equipped with state-of-the-art diagnostic tools to ensure your vehicle operates at peak efficiency.",
  card1: {
    title: "Engine Diagnostics",
    body: "Advanced telemetry and digital mapping to unlock hidden horsepower.",
    ctaLabel: "View specs",
    ctaHref: "/services",
    imageUrl: "",
    imageAlt: "",
  ...
  card2: {
    iconLabel: "OIL",
    title: "Synthetic Fluid Exchange",
    body: "We use exclusive race-grade lubricants for maximum thermal stability.",
  ...
  card3: {
    ...
    body: "High-friction pads and carbon-ceramic rotor installation for ultimate stopping power.",
    ctaLabel: "",
    ctaHref: "",
    imageUrl: "",
    imageAlt: "",
  ...
  card4: {
    ...
    body: "Direct access to OEM and aftermarket excellence from our curated warehouse.",
